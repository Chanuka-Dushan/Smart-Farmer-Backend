...
function Dashboard() {
  ...
  const stats = [
    {
      title: "Total Users",
      value: loading ? "..." : userStats.total_users.toString(),
      change: "+20.1%",
      icon: Users,
      trend: "up"
    },
    {
      title: "Active Users",
      value: loading ? "..." : userStats.active_users.toString(),
      change: "+15.3%",
      icon: Users,
      trend: "up"
    },
    {
      title: "Banned Users",
      value: loading ? "..." : userStats.banned_users.toString(),
      change: "0%",
      icon: Package,
      trend: "neutral"
    },
    {
      title: "Deleted Users",
      value: loading ? "..." : userStats.deleted_users.toString(),
      change: "+2.4%",
      icon: TrendingUp,
      trend: "up"
    }
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <Button className="h-24 bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700">
                <div className="flex flex-col items-center gap-2">
                  <Users className="h-6 w-6" />
                  <span>Manage Users</span>
                </div>
              </Button>
              <Button className="h-24 bg-gradient-to-br from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700">
                <div className="flex flex-col items-center gap-2">
                  <Package className="h-6 w-6" />
                  <span>View Orders</span>
                </div>
              </Button>
              <Button className="h-24 bg-gradient-to-br from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700">
                <div className="flex flex-col items-center gap-2">
